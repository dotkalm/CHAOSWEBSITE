...
describe('useIdleFade', () => {
  ...
  describe('Initial state', () => {
    it('should return opacity 1 initially', () => {
      ...
      act(() => {
        const hook = renderHook(() => useIdleFade(lastMoveTime))
        result = hook.result
      })
  ...
  describe('Idle threshold (3 minutes)', () => {
    ...
    it('should begin fading after 3 minutes (180000ms)', () => {
      ...
      act(() => {
        const hook = renderHook(() => useIdleFade(lastMoveTimePastThreshold))
        result2 = hook.result
      })
  ...
  describe('Animation loop', () => {
    it('should use requestAnimationFrame for smooth updates', () => {
      ...
      act(() => {
        const { unmount: u } = renderHook(() => useIdleFade(lastMoveTime))
        unmount = u
      })
